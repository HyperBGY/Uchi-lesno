...
function handleMediaChange(e) {
  if (e.matches) {
    ...
    document.getElementById("homestuff").style.top="100px" ;

    document.getElementById("upcoming").style.top="100px" ;
    ...
    document.getElementById("homestuff").style.top="px" ;

    document.getElementById("upcoming").style.top="0px" ;
...
const mediaQuery = window.matchMedia('(max-width: 40%)');
